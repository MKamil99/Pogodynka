...
// Adapter used in displaying hourly forecast in Senior Fragment:
class SeniorHourlyForecastAdapter(private val getIcon : (String) -> Int) : RecyclerView.Adapter<SeniorHourlyForecastAdapter.ViewHolder>() {
